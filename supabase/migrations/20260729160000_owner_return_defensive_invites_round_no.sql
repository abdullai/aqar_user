-- إصلاح جذري: إتاحة فرصة / إعادة للسوق لا تفشل إن غاب listing_request_invites.round_no
-- 1) يضمن وجود العمود
-- 2) يعيد تعريف owner_return_request_to_market ليحدّث invites بأمان (مع/بدون round_no)
...
BEGIN
  ...
  -- invites: لا نفشل إن غاب round_no على الإنتاج القديم
